<?php
    ...
    $st1 = $pdo->prepare("select * from village");
    $st1->execute();
    $res = null;
?> 
                  ...
                  <div class="col-lg-12">
                      <SECTION class="panel">
                          <HEADER class="panel-heading">
                           Formulaire de saisie des Clients 
                         </HEADER>
                             ...
                             <form id="frm-alumno" action="?c=client&a=Enregistrer" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="Id" value="<?php echo $client->Id; ?>" />
                                <div class="form-group">
                                    <label>CIN</label>
                                    <input type="text" name="CIN" value="" class="form-control" placeholder="CIN du Client" required>
                                </div>
                                <div class="form-group">
                                    <label>NOM</label>
                                    <input type="text" name="Nom" value="" class="form-control" placeholder="Nom du Client" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>Telephone</label>
                                    <input type="text" name="Tel" value="" class="form-control" placeholder="N° Telephone du Client" required>
                                </div>
                           
                                <div class="form-group">
                                      <label for="IdVillage">Village</label>
                                        <select class="form-control" name="IdVillage" placeholder="Village du Client" required>> 
                                          <?php
                                              echo "<option></option>\n";
...
<table class="table  table-striped  table-hover" id="tabla">
    ...
    <?php foreach($this->model->Lister() as $r): ?>
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="javascript:return confirm('Voulez vous supprimer cet enregistrement?');" href="?c=client&a=Supprimer&Id=<?php echo $r->Id; ?>">Supprimer</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
