<?php
    ...
    $st1 = $pdo->prepare("select * from client");
    $st1->execute();
    $res1 = null;

    $st2 = $pdo->prepare("select * from compteur");
    $st2->execute();
    $res2 = null;
                               ...
                               <input type="hidden" name="Id" value="<?php echo $abonnement->Id; ?>" />
                                ...
                                <div class="form-group">
                                      <label for="IdClient">Client</label>
                                        <select class="form-control" name="IdClient" placeholder="Client" required>> 
                                          <?php
                                              echo "<option></option>\n";
                                              while($res1 = $st1->fetch(PDO::FETCH_NUM))
                                              {
                                  ...
                                  <div class="form-group">
                                      <label for="IdCompteur">Compteur</label>
                                        <select class="form-control" name="IdCompteur" placeholder="Compteur" required>> 
                                          <?php
                                              echo "<option></option>\n";
                                              while($res2 = $st2->fetch(PDO::FETCH_NUM))
                                              {
